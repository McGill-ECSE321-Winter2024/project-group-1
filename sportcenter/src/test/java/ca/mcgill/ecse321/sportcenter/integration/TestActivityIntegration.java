...
public class TestActivityIntegration {
    @Autowired
    private TestRestTemplate client; // Always stays the same

    @Autowired
    private ActivityRepository activityRepository; // TODO: Make sure it's the good type

    @BeforeEach
    @AfterEach
    public void clearDatabase() {
        activityRepository.deleteAll(); // TODO: Make sure it's the good type
    }
