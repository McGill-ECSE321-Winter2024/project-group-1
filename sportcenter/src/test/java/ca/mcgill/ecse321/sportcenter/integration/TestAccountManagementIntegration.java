...
// private static final InstructorStatus INSTRUCTOR_STATUS =
...
// ResponseEntity<AccountDto> response = account.getForEntity(url,
// AccountDto.class);
...
// account.postForEntity("/updateAccountUsername/" + OLD_USERNAME + "/"
...
// account.postForEntity("/updateAccountPassword/" + USERNAME + "/"
...
// ResponseEntity<ErrorDto> response =
// account.postForEntity("/updateAccountPassword/" + PASSWORD + "/"
...
// account.getForEntity("/deleteCustomerAccount/" + ACCOUNTROLEID,
// CustomerDto.class);
// assertEquals(HttpStatus.OK, response.getStatusCode());
// assertNotNull(response.getBody());
// }
...
// account.getForEntity("/getinstructor/" + ACCOUNTROLEID,
// InstructorDto.class);
// assertEquals(HttpStatus.OK, response.getStatusCode());
// assertNotNull(response.getBody());
...
// ResponseEntity<InstructorDto[]> response =
// account.getForEntity("/instructors", InstructorDto[].class);
// assertNotNull(response);
// assertEquals(HttpStatus.OK, response.getStatusCode());
...
// ResponseEntity<ErrorDto> response =
// account.postForEntity("/updateInstructorAccount/" + USERNAME + "/"
...
// ResponseEntity<InstructorDto> response =
// account.getForEntity("/deleteInstructorAccount/" + USERNAME,
// InstructorDto.class);
// assertEquals(HttpStatus.OK, response.getStatusCode());
// assertNotNull(response.getBody());
// assertNull(instructorRepository.findInstructorByAccountRoleId(ACCOUNTROLEID));
...
// ResponseEntity<ErrorDto> response =
// account.getForEntity("/deleteInstructorAccount/" + INVALID_USERNAME,
// ErrorDto.class);
// assertEquals(HttpStatus.NOT_FOUND, response.getStatusCode());
// assertNotNull(response.getBody());
// assertEquals(1, response.getBody().getErrors().size());
