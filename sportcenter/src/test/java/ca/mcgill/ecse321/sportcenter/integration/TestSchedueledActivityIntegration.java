...
public class TestSchedueledActivityIntegration {
    ...
    public void testCreateScheduledActivity() {
        ...
        ScheduledActivityDto act = new ScheduledActivityDto(ScheduledActivityId, DATE, START_TIME, END_TIME, instructor,
    ...
    public void testCreateScheduledActivityNullDate() {
        ...
        Activity newActivity = new Activity(CATEGORY, ACTIVITY_NAME, NOT_APPROVED, DESCRIPTION);
        activityRepository.save(newActivity);
        ScheduledActivityDto act = new ScheduledActivityDto(ScheduledActivityId, null, START_TIME, END_TIME, instructor,
                newActivity, CAPACITY);
    ...
    public void testCreateScheduledActivityNullStartTime() {
        ...
        Activity newActivity = new Activity(CATEGORY, ACTIVITY_NAME, NOT_APPROVED, DESCRIPTION);
        activityRepository.save(newActivity);
        ScheduledActivityDto act = new ScheduledActivityDto(ScheduledActivityId, DATE, null, END_TIME, instructor,
                newActivity, CAPACITY);
    ...
    public void testCreateScheduledActivityNullEndTime() {
        ...
        Activity newActivity = new Activity(CATEGORY, ACTIVITY_NAME, NOT_APPROVED, DESCRIPTION);
        activityRepository.save(newActivity);
        ScheduledActivityDto act = new ScheduledActivityDto(ScheduledActivityId, DATE, START_TIME, null, instructor,
                newActivity, CAPACITY);
    ...
    public void testCreateScheduledActivityNullInstructor() {
        Activity newActivity = new Activity(CATEGORY, ACTIVITY_NAME, NOT_APPROVED, DESCRIPTION);
        activityRepository.save(newActivity);
        ScheduledActivityDto act = new ScheduledActivityDto(ScheduledActivityId, DATE, START_TIME, END_TIME, null,
                newActivity, CAPACITY);
    ...
    public void testGetAllScheduledActivityByInstructorId() {
        ...
        ResponseEntity<ScheduledActivityDto[]> response2 = client.getForEntity("/scheduledActivity/" + INSTRUCTOR_ID,
                ScheduledActivityDto[].class);
        ScheduledActivityDto[] act3 = response2.getBody();
        assertNotNull(act3);
        assertEquals(1, act3.length);
    ...
    public void testUpdateScheduledActivityNull() {
        ...
        ResponseEntity<ErrorDto> response2 = client.postForEntity("/scheduledActivity/" + NEW_ScheduledActivityId, act3,
                ErrorDto.class);
    ...
    public void testUpdateScheduledActivityNullDate() {
        ...
        ScheduledActivityDto act3 = new ScheduledActivityDto(ScheduledActivityId, null, NEW_START_TIME,
                NEW_END_TIME, instructor,
                newActivity, CAPACITY);
        ResponseEntity<ErrorDto> response2 = client.postForEntity("/scheduledActivity/" + ScheduledActivityId, act3,
                ErrorDto.class);
        ErrorDto act4 = response2.getBody();
        assertNotNull(act4);
