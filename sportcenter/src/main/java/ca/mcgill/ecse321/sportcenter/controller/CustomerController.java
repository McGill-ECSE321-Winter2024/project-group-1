...
public class CustomerController {
     ...
     */
     ...
     public ResponseEntity<?> createCustomer(@RequestParam("username") String username) {
            try {
    ...
    public ResponseEntity<?> getAllCustomers() {
        try {
            ...
            return ResponseEntity.ok(CustomerDto.convertToDto(customers));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
    }
    ...
    public ResponseEntity<?> updateCustomer(@PathVariable("accountRoleId") int accountRoleId, @RequestParam("username") String username) {
        try {
    ...
    @GetMapping(value = {"/getCustomersAttendingScheduledActivity/{scheduledActivity}", "/getCustomersAttendingScheduledActivity/{scheduledActivity}/"})
    public ResponseEntity<?> getCustomersAttendingScheduledActivity(@PathVariable("scheduledActivity") ScheduledActivity scheduledActivity) {
        try {
            List<Customer> customers = customerService.getCustomersAttendingScheduledActivity(scheduledActivity);
            return ResponseEntity.ok(CustomerDto.convertToDto(customers));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
