...
public class InstructorService {
     ...
     */
    @Transactional
    public ScheduledActivity makeScheduledActivity(LocalDate date, LocalTime startTime, LocalTime endTime, Instructor instructor, Activity activity, int capacity) {
