...
/**
 * Controller class for the Activity entity
 * 
 * @author Andrew Nemr
 */
@CrossOrigin(origins = "*")
...
public class ActivityController {
    ...
    public List<ActivityDto> getActivitiesBySubcategory(
        ...
        List<Activity> activities = activityService.getActivitiesBySubcategory(subcategory);
        List<ActivityDto> activityDtos = new ArrayList<ActivityDto>();
        for (Activity activity : activities) {
            activityDtos.add(convertToDto(activity));
        }
    ...
    public static ActivityDto convertToDto(Activity activity) {
        return new ActivityDto(activity.getSubCategory(), activity.getName(), activity.getIsApproved(),
                activity.getDescription());
    }

    /**
     * Convert a list of activities to DTOs
     * 
     * @param activities
     * @return List<ActivityDto>
     */
