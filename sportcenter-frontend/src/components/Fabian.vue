    ...
    <div class="fabian">
      <div id="proposeBox" class="propose-activity">
        <VBox id="containerF">
          ...
          <button id="submitPropose" @click="created()">
            <b>Get Activities</b>
          </button>
          <button id="submitPropose" @click="submitProposeActivity()">
            <b>Propose to Owner</b>
          </button>
      ...
      <div id="scheduleBox" class="schedule-activity">
        <VBox id="containerF2">
          ...
          <div class="right-text-fields">
            ...
            <input
              type="text"
              placeholder="Account Role Id"
              v-model="accountRoleId"
            />
            <br />
            <input
              type="text"
              placeholder="Activity Name"
              v-model="activityName2"
            />
            <br />
            <input type="text" placeholder="Capacity" v-model="capacity" />
          </div>
          <button id="scheduleActivity" @click="submitScheduleActivity()">
...
export default {
  ...
  methods: {
    ...
    async submitScheduleActivity() {
      ...
      try {
        const response = await client.createScheduleActivity(
